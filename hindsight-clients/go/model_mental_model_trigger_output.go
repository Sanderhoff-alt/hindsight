...
func (o *MentalModelTriggerOutput) GetTimezone() string {
...
// and a boolean to check if the value has been set.
func (o *MentalModelTriggerOutput) GetTimezoneOk() (*string, bool) {
	if o == nil || IsNil(o.Timezone) {
		return nil, false
	}
...
func (o *MentalModelTriggerOutput) HasTimezone() bool {
	if o != nil && !IsNil(o.Timezone) {
		return true
	}
...
func (o *MentalModelTriggerOutput) SetTimezone(v string) {
	o.Timezone = &v
}
