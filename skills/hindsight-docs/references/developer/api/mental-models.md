...
| `refresh_cron` | string \| null | null | 5-field cron expression evaluated in the trigger's timezone, such as `"0 3 * * *"` for a daily 03:00 schedule |
| `timezone` | string \| null | `"UTC"` | Optional IANA timezone used to evaluate `refresh_cron`, such as `"Asia/Shanghai"`. Existing triggers without this field use UTC. |
