...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoriesPy} section="delete-memory" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoriesMjs} section="delete-memory" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoriesSh} section="delete-memory" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoriesGo} section="delete-memory" language="go" />
</TabItem>
</Tabs>
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoriesPy} section="bulk-delete-memories" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoriesMjs} section="bulk-delete-memories" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoriesSh} section="bulk-delete-memories" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoriesGo} section="bulk-delete-memories" language="go" />
</TabItem>
</Tabs>
